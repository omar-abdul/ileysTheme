            ...
            <!-- <div id="carousel-slideshow" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="<?php print $slide1?>" alt="First slide">
                    </div>
                     <div class="carousel-item">
                        <img class="d-block w-100" src="<?php print $slide2?>"  alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php print $slide3?>"  alt="Third slide">
                    </div>
                 </div>
